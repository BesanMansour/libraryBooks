        ...
        <form method="POST" action="{{ route('login') }}">
            @csrf
                        ...
                        <div class="form-group fv-plugins-icon-container">
                            ...
                            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" id="email" type="email" name="email" :value="old('email')" required autofocus >
                  ...
                  <!--begin::Form group-->
                        <div class="form-group fv-plugins-icon-container">
                            ...
                            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" id="password"  type="password"
                                name="password"
            ...
            <div class="flex items-center justify-end mt-4">
              ...
              <x-button class="btn btn-primary" style="background-color: #986923;margin-right:220px">
                    {{ __('Log in') }}
                </x-button>
                ...
                <div class="login-form login-signup">
                    <!--begin::Form-->
                    <form class="form" novalidate="novalidate" id="kt_login_signup_form" method="POST" action="{{ route('login') }}">
                        @csrf
